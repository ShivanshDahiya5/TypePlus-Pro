                                ...
                                <div className="space-y-2 pt-2 border-t" style={{ borderColor: theme.border }}>
                                    <label className="flex items-center justify-between cursor-pointer select-none">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => onUpdatePreferences({ showLiveStats: e.target.checked })}
                                            className="rounded cursor-pointer"
                                        />
                                    </label>

                                    <label className="flex items-center justify-between cursor-pointer select-none">
                                        <span>Virtual Keyboard Guide</span>
                                        <input
                                            type="checkbox"
                                    ...
                                    <label className="flex items-center justify-between cursor-pointer select-none">
                                        <span>Blind Mode (hide error colors)</span>
                                        <input
                                            type="checkbox"
                                            checked={preferences.blindMode}
                                            onChange={(e) => onUpdatePreferences({ blindMode: e.target.checked })}
                                            className="rounded cursor-pointer"
                                        />
                                    </label>
                                </div>
